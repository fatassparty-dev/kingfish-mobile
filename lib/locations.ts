...
// Dropdown options for the signup location field. Mirrors the web
// (kingfish-bets/lib/locations.ts) verbatim so the two surfaces match: "Other /
// outside US" first, then US states + Puerto Rico sorted alphabetically by name
// (PR after Pennsylvania, before Rhode Island).
export const SPECIAL_LOCATION_OPTIONS = [
...
export const LOCATION_OPTIONS = [...SPECIAL_LOCATION_OPTIONS, ...US_STATE_OPTIONS]
